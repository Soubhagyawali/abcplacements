...
const BarGraph = () => {
    ...
    const getPercentage = async () => {
      ...
      if (snapshot.exists()) {
        ...
        let obj = [
          {"name":2021, "value":res_data[0].value1},
          {"name":2022, "value":res_data[0].value2},
          {"name":2023, "value":res_data[0].value3},
          {"name":2024, "value":res_data[0].value4},
          {"name":2025, "value":res_data[0].value5},
        ]
