      ...
      <div className="home_container">
        ...
        <div className="container_home_center">
          ...
          <div className="home_text_div">
            <h1><a href='https://www.dypcoeakurdi.ac.in/' target='_blank' className='college_name'  > ABC College of Engineering</a></h1>
            <h2 className='dept_name'>Department of Computer Science and Business Systems</h2>
          </div>
